...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('sortOrder').addEventListener('change', function() {
        ...
        // 👇 Nuevo: listener para el select de Consumed
    document.getElementById('consumed').addEventListener('change', function() {
        currentConfig.consumed = this.value;
    });
    
    // Inicializar con el valor actual del select (por si ya viene preseleccionado)
    currentConfig.consumed = document.getElementById('consumed').value;
