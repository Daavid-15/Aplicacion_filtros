...
async function reloadTensors() {
    try {
        ...
        const payload = {
            ...
            Consumed: currentConfig.consumed   
        };
    ...
    try {
        const config = {
            lightglue_conf: {
                ...
                n_layers: parseInt(document.getElementById('n_layers').value)  // Nuevo parámetro
            },
            preprocessing: {
            ...
            batch_size: parseInt(document.getElementById('numBatches').value),
            thresholds: JSON.parse(document.getElementById('thresholdsConfig').value),
            default_threshold: parseInt(document.getElementById('defaultThreshold').value)
        };
